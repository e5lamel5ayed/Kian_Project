    ...
    <nav class="navbar navbar-default fixed-top">
        <div class="row" style="flex-grow: 1;">
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2" id="logo">
                ...
                <a href="{{ route('home') }}" class="float-xl-right"><img src="{{ asset('frontend/img/logo.png') }}" width="70" height="50" /></a>
            </div>
            <div class="col-md-3 col-lg-6 col-xl-6 d-none d-md-block mt-auto mb-auto">
