                        ...
                        <div class="row cv-header">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 float-md-right col-sm-6 float-sm-right col-6">
                                <div class="cv-category-detail cv-enroll float-lg-right float-md-right float-sm-right">
                                    <a href="javascript::void(0);" class="btn btn-ULEARN-cview mt-1" data-toggle="modal"
                                        data-target="#rateModal">RATE COURSE</a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="container">
                                                ...
                                                @foreach ($curriculum_lectures as $curriculum_lecture)
                                                    ...
                                                    <div class="row lecture-container">
                                                        ...
                                                        @php
                                                            $is_completed = SiteHelpers::getCoursecompletedStatus(
                                                                $curriculum_lecture->lecture_quiz_id,
                                                            );
                                                        @endphp
                                                        <div class="col-3 my-auto">
                                                            <article class="preview-time">
                                                                ...
                                                                <a href="{{ url('course-enroll/' . $course->course_slug . '/' . SiteHelpers::encrypt_decrypt($curriculum_lecture->lecture_quiz_id, true)) }}"
                                                                    class="btn btn-ULEARN-preview">
                                                                    @if ($is_completed)
                                                                        RESTART
                                                                    @else
                                                                        START
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                    <section class="course-feature">
                        ...
                        <div class="cf-pricing">
                            <span>PRICING:</span>
                            <button
                                class="cf-pricing-btn btn">{{ $course->price == '' || $course_price == 0.0 ? 'FREE' : 'PAID' }}</button>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="becomeInstructorForm">
                        <form id="rateCourseForm" class="form-horizontal" method="POST"
                            action="{{ route('course.rate') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="px-4 py-2">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5">
                                            @if ($course_rating->id)
                                                <a class="btn btn-sm btn-block delete-review delete-record"
                                                    href="{{ route('delete.rating', $course_rating->id) }}">Delete
                                                    Review</a>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mt-4">
                                    <button type="submit"
                                        class="btn btn-lg btn-block login-page-button">{{ $course_rating->id ? 'Update' : 'Add' }}
                                        Review</button>
                                </div>
