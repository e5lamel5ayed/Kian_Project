            ...
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ $instructor->first_name . ' ' . $instructor->last_name }}</li>
                </ol>
            </div>
        </div>
            ...
            <div class="row mt-4">
                <div class="col-xl-3 col-lg-4 col-md-5 d-none d-md-block">
                    ...
                    <div class="rightRegisterForm ml-0">
                        ...
                        <div class="px-4 py-2">
                            <form class="form-horizontal" method="POST" action="{{ route('contact.instructor') }}"
                                id="instructorForm">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group mt-4">
                                    <button type="submit" class="btn btn-lg btn-block login-page-button">Send
                                        Message</button>
                                </div>
                            </form>
                    ...
                    @if (count($instructor->courses) > 0)
                        <div class="row">
                            <div class="col-12 text-center seperator-head mt-0">
                                <h4>Courses</h4>
                                <p class="mt-3">Courses taught by
