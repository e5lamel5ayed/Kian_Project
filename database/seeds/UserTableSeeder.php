...
class UserTableSeeder extends Seeder
{
  public function run()
  {
    ...
    if (!$is_exist->count()) {
        ...
        $student->email = 'student@KIAN.com';
        ...
        $instructor_user->email = 'instructor@KIAN.com';
        ...
        $instructor->contact_email = 'instructor@KIAN.com';
        $instructor->telephone = '+61 (800) 123-54323';
        $instructor->mobile = '+61 800-1233-8766';
        $instructor->paypal_id = 'instructor@KIAN.com';
        ...
        $instructor->instructor_image = 'instructor/2/angela.jpg';
        $instructor->save();
