...
echo Carbon::parse('2024-07-23 14:51')->isoFormat('LLLL'); // 'Tuesday, July 23, 2024 2:51 PM'
echo Carbon::parse('2024-07-23 14:51')->locale('fr_FR')->isoFormat('LLLL'); // 'mardi 23 juillet 2024 14:51'
