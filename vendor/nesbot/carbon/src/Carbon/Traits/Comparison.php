...
trait Comparison
{
     ...
     * @example
     * ```
     * Carbon::parse('2024-07-14')->isWeekday(); // false
     * Carbon::parse('2024-07-15')->isWeekday(); // true
     * ```
     *
     * @return bool
     */
     ...
     * @example
     * ```
     * Carbon::parse('2024-07-14')->isWeekend(); // true
     * Carbon::parse('2024-07-15')->isWeekend(); // false
     * ```
     *
     * @return bool
     */
     ...
     * Carbon::parse('2024-01-01')->isLeapYear(); // false
     * ```
     *
     * @return bool
     */
     ...
     * it's not correct if the exact date matters. For instance as `2024-12-30` is already
     ...
     * Carbon::parse('2024-12-29')->isLongIsoYear(); // false
     * Carbon::parse('2024-12-30')->isLongIsoYear(); // true
     * ```
     *
     * @see https://en.wikipedia.org/wiki/ISO_8601#Week_dates
     *
     ...
     * @example
     * ```
     * Carbon::parse('2024-06-13')->isSameAs('Y-d', Carbon::parse('2024-12-13')); // true
     * Carbon::parse('2024-06-13')->isSameAs('Y-d', Carbon::parse('2024-06-14')); // false
     * ```
     *
     ...
     * @example
     * ```
     * Carbon::parse('2024-01-13')->isSameUnit('year', Carbon::parse('2024-12-25')); // true
     * Carbon::parse('2018-12-13')->isSameUnit('year', Carbon::parse('2024-12-25')); // false
     * ```
     *
     ...
     * @example
     * ```
     * Carbon::parse('2024-01-12')->isSameQuarter(Carbon::parse('2024-03-01')); // true
     * Carbon::parse('2024-01-12')->isSameQuarter(Carbon::parse('2024-04-01')); // false
     * Carbon::parse('2024-01-12')->isSameQuarter(Carbon::parse('2018-03-01')); // false
     * Carbon::parse('2024-01-12')->isSameQuarter(Carbon::parse('2018-03-01'), false); // true
     * ```
     *
     ...
     * @example
     * ```
     * Carbon::parse('2024-01-12')->isSameMonth(Carbon::parse('2024-01-01')); // true
     * Carbon::parse('2024-01-12')->isSameMonth(Carbon::parse('2024-02-01')); // false
     * Carbon::parse('2024-01-12')->isSameMonth(Carbon::parse('2018-01-01')); // false
     * Carbon::parse('2024-01-12')->isSameMonth(Carbon::parse('2018-01-01'), false); // true
     * ```
     *
     ...
     * @example
     * ```
     * Carbon::parse('2024-07-17')->isDayOfWeek(Carbon::WEDNESDAY); // true
     * Carbon::parse('2024-07-17')->isDayOfWeek(Carbon::FRIDAY); // false
     * Carbon::parse('2024-07-17')->isDayOfWeek('Wednesday'); // true
     * Carbon::parse('2024-07-17')->isDayOfWeek('Friday'); // false
     * ```
     *
     * @param int $dayOfWeek
     *
     ...
     * Carbon::parse('2024-06-05')->isBirthday(Carbon::parse('2001-06-05')); // true
     * Carbon::parse('2024-06-05')->isBirthday(Carbon::parse('2001-06-06')); // false
     * ```
     *
     ...
     * @example
     * ```
     * Carbon::parse('2024-02-28')->isLastOfMonth(); // true
     * Carbon::parse('2024-03-28')->isLastOfMonth(); // false
     * Carbon::parse('2024-03-30')->isLastOfMonth(); // false
     * Carbon::parse('2024-03-31')->isLastOfMonth(); // true
     * Carbon::parse('2024-04-30')->isLastOfMonth(); // true
     * ```
     *
     * @return bool
     */
     ...
     * @example
     * ```
     * Carbon::parse('2024-02-28 00:00:00')->isStartOfDay(); // true
     * Carbon::parse('2024-02-28 00:00:00.999999')->isStartOfDay(); // true
     * Carbon::parse('2024-02-28 00:00:01')->isStartOfDay(); // false
     * Carbon::parse('2024-02-28 00:00:00.000000')->isStartOfDay(true); // true
     * Carbon::parse('2024-02-28 00:00:00.000012')->isStartOfDay(true); // false
     * ```
     *
     ...
     * @example
     * ```
     * Carbon::parse('2024-02-28 23:59:59.999999')->isEndOfDay(); // true
     * Carbon::parse('2024-02-28 23:59:59.123456')->isEndOfDay(); // true
     * Carbon::parse('2024-02-28 23:59:59')->isEndOfDay(); // true
     * Carbon::parse('2024-02-28 23:59:58.999999')->isEndOfDay(); // false
     * Carbon::parse('2024-02-28 23:59:59.999999')->isEndOfDay(true); // true
     * Carbon::parse('2024-02-28 23:59:59.123456')->isEndOfDay(true); // false
     * Carbon::parse('2024-02-28 23:59:59')->isEndOfDay(true); // false
     * ```
     *
     * @param bool $checkMicroseconds check time at microseconds precision
     *
     ...
     * @example
     * ```
     * Carbon::parse('2024-02-28 00:00:00')->isMidnight(); // true
     * Carbon::parse('2024-02-28 00:00:00.999999')->isMidnight(); // true
     * Carbon::parse('2024-02-28 00:00:01')->isMidnight(); // false
     * ```
     *
     * @return bool
     */
     ...
     * @example
     * ```
     * Carbon::parse('2024-02-28 11:59:59.999999')->isMidday(); // false
     * Carbon::parse('2024-02-28 12:00:00')->isMidday(); // true
     * Carbon::parse('2024-02-28 12:00:00.999999')->isMidday(); // true
     * Carbon::parse('2024-02-28 12:00:01')->isMidday(); // false
     * ```
     *
     * @return bool
     */
     ...
     * @example
     * ```
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('2024')); // true
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('2018')); // false
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('2024-06')); // true
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('06-02')); // true
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('2024-06-02')); // true
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('Sunday')); // true
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('June')); // true
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('12:23')); // true
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('12:23:45')); // true
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('12:23:00')); // false
     * var_dump(Carbon::parse('2024-06-02 12:23:45')->is('12h')); // true
     * var_dump(Carbon::parse('2024-06-02 15:23:45')->is('3pm')); // true
     * var_dump(Carbon::parse('2024-06-02 15:23:45')->is('3am')); // false
     * ```
     *
