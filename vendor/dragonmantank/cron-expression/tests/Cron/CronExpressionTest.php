...
class CronExpressionTest extends TestCase
{
   ...
   /**
    ...
    {
        $cron = CronExpression::factory('@weekly');
        $date = new DateTime("2024-03-10 00:00:00");
        $this->assertEquals($date, $cron->getNextRunDate("2024-03-03 08:00:00"));
        $this->assertEquals($date, $cron->getNextRunDate(new DateTime("2024-03-03 08:00:00")));
        $this->assertEquals($date, $cron->getNextRunDate(new DateTimeImmutable("2024-03-03 08:00:00")));
    }
